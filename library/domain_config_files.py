...
class DomainConfigs(object):
    ...
    def run(self):
        ...
        for cert in self.certificates:
            ...
            tmp_file = os.path.join(self.tmp_directory, domain)
            ...
            if changed:
                ...
                if os.path.exists(f"{tmp_file}.yml"):
                    shutil.copyfile(f"{tmp_file}.yml", f"{file_name}.yml")
    ...
    def __template(self, domain_list):
        """
          generate data from dictionary
        """
        tpl = """# generated by ansible
...
"""
    ...
    def __write_file(self, domains, data_file):
        ...
        with open(f"{data_file}.yml", "w") as f:
            f.write(data)

        data = self.__template(domains)
